...
///
/// @param[in] lane_id: a maliput-style identifier based on
/// drake::automotive::api::TypeSpecificIdentifier<class Lane>
/// "TypeSpecificIdentifier"
///
/// @param[in] road_geometry Search over this road geometry.
