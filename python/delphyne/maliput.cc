...
PYBIND11_MODULE(maliput, m) {
  ...
  m.def("create_dragway", &delphyne::maliput::CreateDragway,
        "Create a simple multi-lane dragway strip",
        py::arg("name"), py::arg("num_lanes"), py::arg("length"),
  ...
  m.def("create_multilane_from_file",
        &delphyne::maliput::CreateMultilaneFromFile,
        "Load a multilane road geometry from file (yaml)",
        py::arg("file_path"));

  m.def("create_monolane_from_file",
        &delphyne::maliput::CreateMonolaneFromFile,
        "Load a monolane road geometry from file (yaml)",
        py::arg("file_path"));

  m.def("create_on_ramp",
        &delphyne::maliput::CreateOnRamp,
