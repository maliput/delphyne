...
struct RoadOdometry {
  ...
  RoadOdometry(
      const drake::maliput::api::RoadPosition& road_position,
  ...
  RoadOdometry(
      const drake::maliput::api::Lane* lane_in,
      const drake::maliput::api::LanePositionT<T>& lane_position,
  ...
  drake::maliput::api::LanePositionT<T> pos{};
