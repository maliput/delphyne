...
template <typename T>
void RailFollower<T>::CalcLaneOutput(const drake::systems::Context<T>& context,
...
template <typename T>
T RailFollower<T>::CalcR(const RailFollowerParams<T>& params,
...
template <typename T>
void RailFollower<T>::CalcVelocity(
    const drake::systems::Context<T>& context,
...
template <typename T>
void RailFollower<T>::DoCalcTimeDerivatives(
    const drake::systems::Context<T>& context,
...
template <typename T>
void RailFollower<T>::DoCalcNextUpdateTime(
    const drake::systems::Context<T>& context,
...
template <typename T>
void RailFollower<T>::DoCalcUnrestrictedUpdate(
    const drake::systems::Context<T>& context,
...
template <typename T>
const RailFollowerState<T>& RailFollower<T>::get_rail_follower_state(
...
template <typename T>
const LaneDirection& RailFollower<T>::get_lane_direction(
    const drake::systems::Context<T>& context) const {
  return context.template get_abstract_state<LaneDirection>(
